...
Aplicar un descuento cuando corresponda.
...
Un filtro no debe invocar directamente a otro filtro.
Un filtro no debe conocer cuál se ejecutó antes ni cuál se ejecutará después.
Todos los filtros deben recibir y devolver un objeto compatible.
La secuencia de procesamiento debe definirse fuera de los filtros.
Agregar un nuevo filtro no deberá requerir modificar los filtros existentes.
Reto obligatorio
