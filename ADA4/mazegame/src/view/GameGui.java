...
import src.model.TheArchitect;
import src.model.TimeCalculator;
import src.model.TimeKeeper;
import src.controller.FileLoader;
...
public class GameGui extends JFrame implements ActionListener {
    ...
    public GameGui() {
        ...
        ),JLabel.LEFT);//GUI background for initial load
        cp.add(shagLabel);
    ...
    private class MyKeyHandler extends KeyAdapter {
        ...
        public void keyPressed (KeyEvent theEvent) {
            ...
            //show how many dimonds are left to collect on the gui!
    ...
    public void nextLevelLoad() {
        ...
        System.gc();
        fl.loadFile( levelsPath + fileName); //load the file we need
