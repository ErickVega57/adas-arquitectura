...
public class FileLoader {
    ...
    public void MatrixLoader(String fileTextLine, int lineNum)throws gameFileError {
        ...
        int sum=0;
        char textVar;
         //it is the first line of the maze file, create The Matrix based on first line of the maze file
        if(lineNum == 0) {
            ...
            for(int i=0; i< fileTextLine.length();i++) {
                 //it is not the first line of the maze file
                ...
                if(textVar == 'E') { //log the position of the exit later use
                    exitXCord = lineNum-1;
                    exitYCord =i;
                    // textVar='W';
